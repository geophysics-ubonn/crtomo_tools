...
def setup():
    ...
    #add non-matplotlib-cmaps "turbo" and "turbo_r" to matplotlib library
    mpl_add_cmap_turbo()
...
def mpl_add_cmap_turbo():
    """
    Loads custom-colormaps 'turbo' and 'turbo_r' (reversed) into the 
    matplotlib-colormap-library. Colormap can be accessed with parameter 'turbo'.
    """
    ...
    turbo_colormap_data_r = turbo_colormap_data[::-1]
    matplotlib.cm.register_cmap('turbo_r', cmap=ListedColormap(turbo_colormap_data_r))
