# -*- coding: utf-8 -*-
#
# crtomo tools documentation build configuration file, created by
...
copyright = u'2017-2026, CRTomo contributors'
...
htmlhelp_basename = 'crtomotoolsdoc'
...
latex_documents = [
    ('index', 'crtomotools.tex', u'crtomo tools Documentation',
     u'crtomo contributors', 'manual'),
]
...
man_pages = [
    ('index', 'crtomotools', u'crtomo tools Documentation',
     [u'crtomo contributors'], 1)
]
...
texinfo_documents = [
    ('index', 'crtomotools', u'crtomo tools Documentation',
     u'crtomo contributors', 'crtomotools', 'One line description of project.',
     'Miscellaneous'),
]
